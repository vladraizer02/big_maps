...
class Button(Label):
    ...
    def render(self, surface):
        ...
        pygame.draw.line(surface, color2, (self.Rect.right - 1, self.Rect.top), (self.Rect.right - 1, self.Rect.bottom),
                         2)
        pygame.draw.line(surface, color2, (self.Rect.left, self.Rect.bottom), (self.Rect.right, self.Rect.bottom - 1),
                         2)
        surface.blit(self.rendered_text, self.rendered_rect)
...
class TextBox(Label):
    ...
    def render(self, surface):
        ...
        if self.focus and self.blink:
            pygame.draw.line(surface, pygame.Color('black'), (self.rendered_rect.right + 2, self.rendered_rect.top + 2),
